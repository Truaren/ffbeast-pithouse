  ...
  return (
    <div className="buttons_page">
      <div className="buttons_header_note">
        ...
        <span>
          Configure the mode for each of the 32 joystick buttons.{" "}
          <strong>None</strong> = disabled, <strong>Normal</strong> = active
          high, <strong>Inverted</strong> = active low, <strong>Pulse</strong> =
          momentary.
        </span>
      </div>
