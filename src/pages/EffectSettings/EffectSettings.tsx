        ...
        <div className="card_body">
          ...
          <Slider
            ...
            infoPanelProps={{
              ...
              impact:
                "Necessary for old games without FFB. For modern sims, set to 0%.",
          ...
          <Slider
            ...
            infoPanelProps={{
              description:
                "Adds constant weight to the steering, simulating mechanical friction and tire feel.",
              impact:
                "Stabilizes the wheel on straights. Too much makes steering feel muddy.",
          ...
          <Slider
            ...
            infoPanelProps={{
              description:
                "How hard the wheel pushes back when you reach the rotation limit.",
              impact:
                "Ensures you don't turn past the Motion Range during intense driving.",
          ...
          <Slider
            ...
            infoPanelProps={{
              description:
                "Extra resistance applied only when hitting the rotation limit.",
              impact:
      ...
      <div className="effects_card">
        ...
        <div className="card_body">
          ...
          <Slider
            ...
            onValueCommit={(v) =>
              setSetting(SettingField.DirectXSpringStrength, v)
            }
            infoPanelProps={{
              description:
                "Scales Spring effects sent by the game engine (distinct from Integrated Spring).",
              impact:
          ...
          <Slider
            ...
            infoPanelProps={{
              description:
                "Scales Constant Force effects, used for sustained G-forces in long corners.",
              impact:
                "Adjusts the 'weight' of the car during turns without losing road texture.",
